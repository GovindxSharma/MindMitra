...
const SignUp = () => {
    ...
    <StyledWrapper>     
      ...
      <div className="form-container">
        <p className="title">Welcome to MindMitra</p>
        <form className="form">
        ...
        <p className="sign-up-label">
          Already have an account?<Link to="/signin"><span className="sign-up-link">Sign in</span></Link>
        </p>
...
const StyledWrapper = styled.div`
  .form-container {
    ...
    box-shadow: rgba(300, 300, 300, 0.35) 0px 0px 15px;
    border-radius: 10px;
    margin-bottom: 80px;
